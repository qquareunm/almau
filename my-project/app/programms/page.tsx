...
const data = [
  ...
  {
    title: "2",
    text: "Целью образования является помощь студентам закрепить базовые знания, необходимые для успешного прохождения вступительных экзаменов, а также развить навыки, которые пригодятся во время учебы в университете....",
    color: "grey",
    className: "graph",
    index: 1,
  },
